...
echo "After installation, you MUST activate the venv to use 'gcptoolkit':"
...
echo ""
echo "IMPORTANT: To use gcptoolkit, activate the virtual environment:"
echo "  source .venv/bin/activate"
echo ""
echo "Then verify with: gcptoolkit version"
echo ""
echo "To make 'gcptoolkit' globally accessible without venv activation,"
